    ...
    return (
      <div>
        ...
        <div className='containerPolytics'>
          ...
          <br />
          <br/><h4>Entidad Responsable</h4>
          La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página Jordi Molto DEV, propiedad de Jordi Moltó Solís – Calle Murillo Alcoy, 03802.
          <br />
          ...
          <br />
          <br/><h4>¿Qué tipos de cookies existen?</h4>
          ...
          <br />
          Las cookies, en función de su permanencia, pueden dividirse en cookies de sesión o permanentes. Las que expiran cuando el usuario cierra el navegador. Las que expiran en función de cuando se cumpla el objetivo para el que sirven (por ejemplo, para que el usuario se mantenga identificado en los servicios de Jordi Moltó Solís) o bien cuando se borran manualmente.
          <br />
          ...
          <br />
          <br/><h4>Cookies de rendimiento</h4>
          ...
          <br />
          <br/><h4> Cookies de geo-localización</h4>
          ...
          <br />
          <br/><h4>Cookies de analíticas</h4>
          Cada vez que un usuario visita un servicio, una herramienta de un proveedor externo genera una cookie analítica en el ordenador del usuario. Esta cookie que sólo se genera en la visita, servirá en próximas visitas a los servicios de Jordi Moltó Solís para identificar de forma anónima al visitante. Los objetivos principales que se persiguen son:
          <br />
          ...
          <br />
          Importante: Salvo que el usuario decida registrarse en un servicio de Jordi Moltó Solís, la cookie nunca irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la experiencia de los usuarios en el sitio.
          <br />
          <br/><h4> Cookies de publicidad</h4>
          Este tipo de cookies permiten ampliar la información de los anuncios mostrados a cada usuario anónimo en los servicios de Jordi Moltó Solís. Entre otros, se almacena la duración o frecuencia de visualización de posiciones publicitarias, la interacción con las mismas, o los patrones de navegación y/o comportamientos del usuario ya que ayudan a conformar un perfil de interés publicitario. De este modo, permiten ofrecer publicidad afín a los intereses del usuario.
          <br />
          <br/><h4>Cookies publicitarias de terceros</h4>
          Además de la publicidad gestionada por las webs de Jordi Moltó Solís en sus servicios, las webs de Jordi Moltó Solís ofrecen a sus anunciantes la opción de servir anuncios a través de terceros (“Ad-Servers”). De este modo, estos terceros pueden almacenar cookies enviadas desde los servicios de Jordi Moltó Solís procedentes de los navegadores de los usuarios, así como acceder a los datos que en ellas se guardan.
          <br />
          Las empresas que generan estas cookies tienen sus propias políticas de privacidad. En la actualidad, las webs de Jordi Moltó Solís utilizan la plataforma Doubleclick (Google) para gestionar estos servicios. Para más información, acuda a
          <br />
          http://www.google.es/policies/privacy/ads/#toc-doubleclick y a http://www.google.es/policies/privacy/ads/.
          <br />
          <br/><h4>¿Cómo puedo deshabilitar las cookies en mi navegador?</h4>
          ...
          <br />
          <br/><h4>Para saber más sobre las cookies</h4>
          ...
          <br />
          <br/><h4>Actualizaciones y cambios en la política de privacidad/cookies</h4>
          Las webs de Jordi Moltó Solís pueden modificar esta Política de Cookies en función de exigencias legislativas, reglamentarias, o con la finalidad de adaptar dicha política a las instrucciones dictadas por la Agencia Española de Protección de Datos, por ello se aconseja a los usuarios que la visiten periódicamente.
          <br />
